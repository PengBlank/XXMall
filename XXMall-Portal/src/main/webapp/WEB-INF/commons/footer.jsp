...
<script type="text/javascript" src="<%=contextPath %>/js/jquery-1.2.6.min.js"></script>
<script type="text/javascript" src="<%=contextPath %>/js/jquery-extend.js"></script>
<script type="text/javascript" src="<%=contextPath %>/js/lib-v1.js" charset="utf-8"></script>
<script type="text/javascript" src="<%=contextPath %>/js/taotao.js" charset="utf-8"></script>
